...
-- 2. Vorhandenen Index für den JOIN über building_id löschen

DROP INDEX idx_train_building ON train;
...
-- 4. Vorhandenen Wetter-Index löschen

DROP INDEX idx_weather_site_time ON weather_train;
...
-- 6. Vorhandenen Gebäude-Index löschen

DROP INDEX idx_building_id
ON ashrae_energy.building_metadata;
...
-- Fehlenden Index für den JOIN über building_id erstellen
CREATE INDEX idx_train_building
ON train (building_id);
...
-- um die Daten anschließend neu und sauber einzufügen.
